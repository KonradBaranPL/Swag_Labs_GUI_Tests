...
def test_inventory_page_has_correct_title(logged_in_page: Page):
...
def test_products_are_visible_on_inventory_page(logged_in_page: Page):
...
def test_facebook_button_redirects_to_correct_url(page: Page, logged_in_page: Page):
...
def test_x_button_redirects_to_correct_url(page: Page, logged_in_page: Page):
...
def test_linkedin_button_redirects_to_correct_url(page: Page, logged_in_page: Page):
